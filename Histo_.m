...
gammaVal = 0.5;
gammaImage = imadjust(grayImage, [], [], gammaVal);  


%  Histogram equalization
histEqImage = histeq(grayPlus20); 
...
subplot(1,5,4); imshow(gammaImage);  title("Gamma = 0.5");
subplot(1,5,5); imshow(histEqImage); title("Hist eq");
